...
- [ ] T004 Confirm touched paths respect `www/` as the gameplay source of truth
...
- [ ] T011 Define performance, asset-loading, and offline fallback validation for the feature
...
- [ ] TXXX Run `npm run validate`
- [ ] TXXX Run browser smoke test with keyboard and touch-sized viewport
- [ ] TXXX Run `npm run cap:sync` before Android verification when Android output is affected
