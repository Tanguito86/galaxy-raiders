...
var _GALAXY_CONFIG_DEFAULTS = {
  ...
  stageDirector: { enabled: true, maxConsecutivePressure: 3, recoveryMinMs: 10000, recoveryMaxIntensity: 0.30, bossPreludeMinMs: 8000, ambushMinSectionGap: 2, setpieceMinLevelGap: 3, survivalCorridorMinLevel: 14, miniSetpieceCooldownSections: 3, climaxIntensityMultiplier: 1.15, telemetry: false },
  scoreSystem: { enabled: true, telemetry: { enabled: true, trackSources: true }, sourceColors: true, debug: { overlay: false }, multiplier: { enabled: true, base: 1.0, max: 3.0, gain: { enemyKill: 0.015, closeRange: 0.020, graze: 0.010, bossHit: 0.008 }, decay: { idleDelayFrames: 180, ratePerFrame: 0.0008 }, penalties: { deathLossPercent: 0.30, hitLossPercent: 0.10 } }, aggression: { enabled: true, closeRange: { near: 60, mid: 120, bonus: { near: 1.75, mid: 1.30 } }, dangerWindow: { enabled: true, frames: 90, bonus: 1.10 }, medals: { chain: { decayEnabled: true, missTierLoss: 2, recoveryGraceFrames: 90 }, multiplier: { gainPerMedal: 0.020, lossPerMiss: 0.010 }, antiExploit: { maxDropsPerWave: 12 } }, bossScoring: { efficiency: { targetPhaseMs: 15000, eliteBonus: 2.0, eliteThreshold: 0.75, goodBonus: 1.4, goodThreshold: 1.0 }, noHit: { phaseBonus: 2500, fullBossBonus: 10000 }, antiMilk: { softCapMs: 30000, scoreDecayAfter: 0.50 }, multiplier: { phaseClearGain: 0.050 } }, survivalScoring: { recovery: { enabled: true, windowFrames: 900, multiplierRestore: 0.10, scoreBonus: 1500 }, noHit: { waveBonus: 750, stageBonus: 5000 }, survivalChain: { levels: [30, 60, 120], multiplierGain: [0.03, 0.06, 0.10] }, antiCamping: { idleFrames: 600, disableWhileIdle: true } }, rankScoreSynergy: { enabled: true, multiplierGainBoost: { rank1: 1.00, rank3: 1.08, rank5: 1.15 }, grazeOpportunityBonus: { rank1: 1.00, rank5: 1.20 }, calibration: { debugOverlay: false } } } },
  readability: {
    enabled: true,
