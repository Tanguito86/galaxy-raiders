...
(function(global) {
  ...
  var PROFILES = {
    ...
    LATE_war_machine: {
      label: 'WAR MACHINE',
      tier: 'late_game',
      tacticalPurpose: 'Level 11 turns confidence into organized warfare without removing recovery.',
      dominantRole: 'suppressor',
      secondaryRole: 'sniper',
      forbiddenRoles: ['chaser'],
      allowedSupport: ['sweeper','flanker','diver'],
      composition: { suppressor: 4, sniper: 3, sweeper: 4, flanker: 2, diver: 1 },
      phaseDurations: { INTRO: 1200, BUILD: 4600 },
      buildTiming: { sweeperDelay: 0, suppressorDelay: 1300, flankerDelay: 2100, sniperDelay: 2800, diverDelay: 4300 },
      peakLimits: { maxSimultaneousPatterns: 3, maxBullets: 30, interPatternGapMs: 190 },
      resolveTiming: { diverSuspend: true, sniperSuspend: true, suppressorSuspend: true, chaserSuspend: true },
      reliefPolicy: 'mandatory_after_crossfire',
      entryStyle: 'slide_in',
      entrySide: 'top',
      formationKey: 'classic_grid',
      formationRows: 4,
      formationCols: 4,
      formationSpacing: 44,
      bannerText: 'WAR MACHINE',
      escapeLanes: 2,
      threatBudget: 48
    },

    LATE_rotating_killbox: {
      label: 'ROTATING KILLBOX',
      tier: 'late_game',
      tacticalPurpose: 'Pre-ORBITAL rehearsal: rotating denial with visible axis shifts.',
      dominantRole: 'flanker',
      secondaryRole: 'sniper',
      forbiddenRoles: ['chaser'],
      allowedSupport: ['sweeper','suppressor'],
      composition: { flanker: 5, sniper: 3, sweeper: 4, suppressor: 2 },
      phaseDurations: { INTRO: 1400, BUILD: 4300 },
      buildTiming: { sweeperDelay: 0, flankerDelay: 1400, suppressorDelay: 2200, sniperDelay: 3000 },
      peakLimits: { maxSimultaneousPatterns: 3, maxBullets: 30, interPatternGapMs: 190 },
      resolveTiming: { diverSuspend: true, sniperSuspend: true, suppressorSuspend: true, chaserSuspend: true },
      reliefPolicy: 'axis_transition_silence',
      entryStyle: 'slide_in',
    ...
    LATE_orbital_siege: {
      label: 'ORBITAL SIEGE',
      tier: 'late_game',
      tacticalPurpose: 'Cold lane compression before ORBITAL; suppressors define walls, flankers rotate pressure.',
      dominantRole: 'suppressor',
      secondaryRole: 'flanker',
      forbiddenRoles: ['chaser'],
      allowedSupport: ['sniper','sweeper'],
      composition: { suppressor: 4, flanker: 4, sniper: 3, sweeper: 3 },
      phaseDurations: { INTRO: 1500, BUILD: 4800 },
      buildTiming: { sweeperDelay: 0, suppressorDelay: 1200, flankerDelay: 2200, sniperDelay: 3200 },
      peakLimits: { maxSimultaneousPatterns: 3, maxBullets: 31, interPatternGapMs: 190 },
      resolveTiming: { diverSuspend: true, sniperSuspend: true, suppressorSuspend: true, chaserSuspend: true },
      reliefPolicy: 'lane_reopens_at_resolve',
      entryStyle: 'slide_in',
      entrySide: 'both_walls',
  ...
  var LEVEL_PROFILE_MAP = {
    ...
    13: 'LATE_rotating_killbox',
    14: 'LATE_orbital_siege',
    16: 'SET_splitter_storm',
    17: 'ADV_survival_corridor',
